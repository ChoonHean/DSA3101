...
# naive_results_df.to_csv("../dataset/low_demand_naive_inventory_results.csv", index=False)
...
# Save results if needed
# algo_result_df.to_csv("../dataset/low_demand_algo_result.csv", index=False)
...
# Save results
comparison.to_csv("../dataset/low_demand_comparison_summary.csv", index=False)
