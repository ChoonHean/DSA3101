...
# Save the raw_data
demand_df.to_csv("data/simulated_demand.csv", index=False)
...
stock_df = pd.DataFrame(stock_data,
                        columns=["cluster_label", "stock_quantity", "lead_time_months", "order_cost", "holding_cost"])

# Save to CSV
stock_df.to_csv("data/simulated_stock.csv", index=False)
